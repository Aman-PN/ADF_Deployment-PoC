...
if [ "$TARGET_BRANCH" == "stage1" ]; then
  SOURCE_BRANCH="develop"
elif [ "$TARGET_BRANCH" == "release1" ]; then
  SOURCE_BRANCH="stage"
else
...
# --- Generate feature branch name with date (DD_MM_YY format) ---
TODAY=$(date +"%d_%m_%y")
...
echo "🔄 Switching the $TARGET_BRANCH branch..."
